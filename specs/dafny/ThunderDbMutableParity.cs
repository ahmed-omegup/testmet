// Dafny program ThunderDbMutableParity.dfy compiled into C#
...
// Command-line arguments: run specs/dafny/ThunderDbMutableParity.dfy --no-verify --allow-warnings
// ThunderDbMutableParity.dfy
...
namespace ThunderDbMutable {
  ...
  public partial class MutableEngine {
    ...
    public Dafny.ISequence<ThunderDbStack._IRetrievalDoc> FillGap(BigInteger queryId)
    {
      ...
      if ((this.queries).Contains(queryId)) {
        ...
        if (((_0_state).dtor_currentMatches) < (((_0_state).dtor_spec).dtor_limit)) {
          ...
          _out0 = (this).QueryDocAtOffset(_0_state, (_0_state).dtor_currentMatches);
          _1_candidate = _out0;
          ...
          }
          {
            ...
            {
              ThunderDbStack._IMaybeDocState _source1 = ThunderDbStack.__default.LookupState(this.store, _2_docId);
              {
              ...
              {
                BigInteger _3_docState = _source1.dtor_state;
                {
                  ...
                  retrievals = Dafny.Sequence<ThunderDbStack._IRetrievalDoc>.FromElements(ThunderDbStack.RetrievalDoc.create(_2_docId, _3_docState, Dafny.Sequence<BigInteger>.FromElements(queryId)));
                }
              }
            after_match1: ;
            }
    ...
    public Dafny.ISequence<ThunderDbStack._IDownstreamEvent> ApplyDocChange(BigInteger id, ThunderDbStack._IMaybeDocState oldState, ThunderDbStack._IMaybeDocState newState)
    {
      ...
      if ((newState).is_HasState) {
        ...
        while ((_8_ni) < (new BigInteger((_2_newMatches).Count))) {
          if ((this.queries).Contains((_2_newMatches).Select(_8_ni))) {
            ...
            if (((_9_state).dtor_currentMatches) < (((_9_state).dtor_spec).dtor_limit)) {
      ...
      Dafny.IMap<BigInteger,bool> _10_oldMatchMap;
      _10_oldMatchMap = Dafny.Map<BigInteger, bool>.FromElements();
      Dafny.IMap<BigInteger,bool> _11_newMatchMap;
      _11_newMatchMap = Dafny.Map<BigInteger, bool>.FromElements();
      BigInteger _12_oi;
      _12_oi = BigInteger.Zero;
      while ((_12_oi) < (new BigInteger((_1_oldMatches).Count))) {
        _10_oldMatchMap = Dafny.Map<BigInteger, bool>.Update(_10_oldMatchMap, (_1_oldMatches).Select(_12_oi), true);
        _12_oi = (_12_oi) + (BigInteger.One);
      }
      BigInteger _13_ni;
      _13_ni = BigInteger.Zero;
      while ((_13_ni) < (new BigInteger((_2_newMatches).Count))) {
        _11_newMatchMap = Dafny.Map<BigInteger, bool>.Update(_11_newMatchMap, (_2_newMatches).Select(_13_ni), true);
        _13_ni = (_13_ni) + (BigInteger.One);
      }
      Dafny.ISequence<ThunderDbStack._IEviction> _14_evictions;
      _14_evictions = Dafny.Sequence<ThunderDbStack._IEviction>.FromElements();
      Dafny.ISequence<ThunderDbStack._IRetrievalDoc> _15_retrievals;
      _15_retrievals = Dafny.Sequence<ThunderDbStack._IRetrievalDoc>.FromElements();
      Dafny.ISequence<BigInteger> _16_matchesOld;
      _16_matchesOld = _1_oldMatches;
      Dafny.ISequence<BigInteger> _17_matchesNew;
      _17_matchesNew = _2_newMatches;
      Dafny.ISequence<BigInteger> _18_lostQueries;
      _18_lostQueries = Dafny.Sequence<BigInteger>.FromElements();
      BigInteger _19_li;
      _19_li = BigInteger.Zero;
      while ((_19_li) < (new BigInteger((_1_oldMatches).Count))) {
        if (!((_11_newMatchMap).Contains((_1_oldMatches).Select(_19_li)))) {
          _18_lostQueries = Dafny.Sequence<BigInteger>.Concat(_18_lostQueries, Dafny.Sequence<BigInteger>.FromElements((_1_oldMatches).Select(_19_li)));
        }
        _19_li = (_19_li) + (BigInteger.One);
      }
      _19_li = BigInteger.Zero;
      while ((_19_li) < (new BigInteger((_18_lostQueries).Count))) {
        Dafny.ISequence<ThunderDbStack._IRetrievalDoc> _20_gapRetrievals;
        Dafny.ISequence<ThunderDbStack._IRetrievalDoc> _out3;
        _out3 = (this).FillGap((_18_lostQueries).Select(_19_li));
        _20_gapRetrievals = _out3;
        _15_retrievals = Dafny.Sequence<ThunderDbStack._IRetrievalDoc>.Concat(_15_retrievals, _20_gapRetrievals);
        _19_li = (_19_li) + (BigInteger.One);
      }
      BigInteger _21_bi;
      _21_bi = BigInteger.Zero;
      while ((_21_bi) < (new BigInteger((_3_blockedCandidates).Count))) {
        if (!((_10_oldMatchMap).Contains((_3_blockedCandidates).Select(_21_bi)))) {
          Dafny.ISequence<BigInteger> _22_evicted;
          Dafny.ISequence<BigInteger> _out4;
          _out4 = (this).PickOverflowDoc((_3_blockedCandidates).Select(_21_bi));
          _22_evicted = _out4;
          if ((new BigInteger((_22_evicted).Count)).Sign == 1) {
            _14_evictions = Dafny.Sequence<ThunderDbStack._IEviction>.Concat(_14_evictions, Dafny.Sequence<ThunderDbStack._IEviction>.FromElements(ThunderDbStack.Eviction.create((_3_blockedCandidates).Select(_21_bi), (_22_evicted).Select(BigInteger.Zero))));
          }
        }
        _21_bi = (_21_bi) + (BigInteger.One);
      }
      ThunderDbStack._IMatchPayload _23_payload;
      _23_payload = ThunderDbStack.MatchPayload.create(id, oldState, newState, _16_matchesOld, _17_matchesNew, _14_evictions);
      if ((ThunderDbStack.__default.HasAnyMatchChange(_23_payload)) && ((new BigInteger((_15_retrievals).Count)).Sign == 1)) {
        events = Dafny.Sequence<ThunderDbStack._IDownstreamEvent>.FromElements(ThunderDbStack.DownstreamEvent.create_MatchEvent(_23_payload), ThunderDbStack.DownstreamEvent.create_RetrievalEvent(_15_retrievals));
      } else if (ThunderDbStack.__default.HasAnyMatchChange(_23_payload)) {
        events = Dafny.Sequence<ThunderDbStack._IDownstreamEvent>.FromElements(ThunderDbStack.DownstreamEvent.create_MatchEvent(_23_payload));
      } else if ((new BigInteger((_15_retrievals).Count)).Sign == 1) {
        events = Dafny.Sequence<ThunderDbStack._IDownstreamEvent>.FromElements(ThunderDbStack.DownstreamEvent.create_RetrievalEvent(_15_retrievals));
      } else {
        events = Dafny.Sequence<ThunderDbStack._IDownstreamEvent>.FromElements();
      }
      return events;
...
namespace ThunderDbMutableParity {

  public partial class __default {
    public static BigInteger NextState(BigInteger state) {
      BigInteger _0_next = Dafny.Helpers.EuclideanModulus((state) * (ThunderDbMutableParity.__default.Multiplier), ThunderDbMutableParity.__default.Modulus);
      if ((_0_next).Sign != 1) {
        return (_0_next) + (ThunderDbMutableParity.__default.Modulus);
      } else {
        return _0_next;
      }
    }
    public static void NextRand(BigInteger state, out BigInteger nextState, out BigInteger @value)
    {
      ...
      nextState = ThunderDbMutableParity.__default.NextState(state);
      @value = nextState;
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ThunderDbMutableParity.MutableParityRunner _0_runner;
      ThunderDbMutableParity.MutableParityRunner _nw0 = new ThunderDbMutableParity.MutableParityRunner();
      _nw0.__ctor();
      _0_runner = _nw0;
      (_0_runner).RunScenario(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("whole-stack-small-parity"), new BigInteger(42), new BigInteger(200), new BigInteger(30), new BigInteger(20), new BigInteger(10), new BigInteger(2), new BigInteger(2), new BigInteger(12), new BigInteger(8));
      ThunderDbMutableParity.MutableParityRunner _nw1 = new ThunderDbMutableParity.MutableParityRunner();
      _nw1.__ctor();
      _0_runner = _nw1;
      (_0_runner).RunScenario(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("whole-stack-benchmark-like-parity"), new BigInteger(123), new BigInteger(800), new BigInteger(120), new BigInteger(30), new BigInteger(35), new BigInteger(8), new BigInteger(8), new BigInteger(25), new BigInteger(10));
    }
  ...
  public partial class MutableParityRunner {
    public MutableParityRunner() {
    ...
    public void CheckState(Dafny.ISequence<Dafny.Rune> name, BigInteger opIndex, ThunderDbStack._IStreamItem item, ThunderDbStack._IEngineState state, Dafny.ISequence<ThunderDbStack._IDownstreamEvent> functionalEvents, Dafny.ISequence<ThunderDbStack._IDownstreamEvent> mutableEvents, BigInteger functionalQueryId, BigInteger mutableQueryId)
    {
      ThunderDbStack._IWorkerRunSummary _0_functionalDelta;
      _0_functionalDelta = ThunderDbStack.__default.UpdateSummary(ThunderDbStack.__default.SummaryZero(), functionalEvents);
      ThunderDbStack._IWorkerRunSummary _1_mutableDelta;
      _1_mutableDelta = ThunderDbStack.__default.UpdateSummary(ThunderDbStack.__default.SummaryZero(), mutableEvents);
      bool _2_mismatch;
      _2_mismatch = (((((((functionalQueryId) != (mutableQueryId)) || (!object.Equals(_0_functionalDelta, _1_mutableDelta))) || (!((state).dtor_store).Equals(this.engine.store))) || (!((state).dtor_docIds).Equals(this.engine.docIds))) || (!(DocsIndexTreap.__default.Entries((state).dtor_treap)).Equals(DocsIndexTreap.__default.Entries(this.engine.docs)))) || (((state).dtor_nextQueryId) != (this.engine.nextQueryId))) || ((new BigInteger(((state).dtor_queries).Count)) != (new BigInteger((this.engine.queries).Count)));
      if (_2_mismatch) {
        ...
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", mutable queryId=")).ToVerbatimString(false));
        Dafny.Helpers.Print((mutableQueryId));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\nfunctional events=")).ToVerbatimString(false));
        Dafny.Helpers.Print((functionalEvents));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\nmutable events=")).ToVerbatimString(false));
        Dafny.Helpers.Print((mutableEvents));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\nfunctional delta=")).ToVerbatimString(false));
        Dafny.Helpers.Print((_0_functionalDelta));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\nmutable delta=")).ToVerbatimString(false));
        Dafny.Helpers.Print((_1_mutableDelta));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      }
      BigInteger _3_i;
      _3_i = BigInteger.Zero;
      while ((_3_i) < (new BigInteger(((state).dtor_queries).Count))) {
        ThunderDbStack._IQueryRuntime _4_query;
        _4_query = ((state).dtor_queries).Select(_3_i);
        Dafny.ISequence<BigInteger> _5_mutableVisible;
        Dafny.ISequence<BigInteger> _out0;
        _out0 = (this.engine).QueryVisible((_4_query).dtor_id);
        _5_mutableVisible = _out0;
        if (((!((this.engine.queries).Contains((_4_query).dtor_id))) || (!object.Equals((Dafny.Map<BigInteger, ThunderDbMutable._IQueryState>.Select(this.engine.queries,(_4_query).dtor_id)).dtor_spec, (_4_query).dtor_spec))) || (!(_5_mutableVisible).Equals((_4_query).dtor_visible))) {
          Dafny.ISequence<BigInteger> _6_mutableVisible;
          Dafny.ISequence<BigInteger> _out1;
          _out1 = (this.engine).QueryVisible((_4_query).dtor_id);
          _6_mutableVisible = _out1;
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("scenario ")).ToVerbatimString(false));
          Dafny.Helpers.Print((name).ToVerbatimString(false));
          ...
          Dafny.Helpers.Print(((_4_query).dtor_id));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\nfunctional visible=")).ToVerbatimString(false));
          Dafny.Helpers.Print(((_4_query).dtor_visible));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\nmutable visible=")).ToVerbatimString(false));
          Dafny.Helpers.Print((_6_mutableVisible));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\nfunctional spec=")).ToVerbatimString(false));
          Dafny.Helpers.Print(((_4_query).dtor_spec));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\nmutable spec=")).ToVerbatimString(false));
          if ((this.engine.queries).Contains((_4_query).dtor_id)) {
            Dafny.Helpers.Print(((Dafny.Map<BigInteger, ThunderDbMutable._IQueryState>.Select(this.engine.queries,(_4_query).dtor_id)).dtor_spec));
          } else {
          ...
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\nmutable store=")).ToVerbatimString(false));
      ...
      if (_2_mismatch) {
        if (!(false)) {
          throw new Dafny.HaltException("specs/dafny/ThunderDbMutableParity.dfy(103,8): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
    }
    public void RunScenario(Dafny.ISequence<Dafny.Rune> name, BigInteger seed, BigInteger documents, BigInteger customers, BigInteger ticks, BigInteger updatesPerTick, BigInteger insertsPerTick, BigInteger deletesPerTick, BigInteger queryLimit, BigInteger density)
    {
      ...
      while ((_7_i) < (documents)) {
        ...
        BigInteger _out0;
        BigInteger _out1;
        ThunderDbMutableParity.__default.NextRand(_2_rng, out _out0, out _out1);
        _8_nextRng = _out0;
        _9_scoreSeed = _out1;
        _2_rng = _8_nextRng;
      ...
      Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _14_mutableEvents;
      BigInteger _15_mutableQueryId;
      Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _out5;
      BigInteger _out6;
      (this.engine).ProcessItem(_10_seedItem, out _out5, out _out6);
      _14_mutableEvents = _out5;
      _15_mutableQueryId = _out6;
      _0_state = _11_nextState;
      _1_summary = ThunderDbStack.__default.UpdateSummary(_1_summary, _12_functionalEvents);
      (this).CheckState(name, _6_opIndex, _10_seedItem, _0_state, _12_functionalEvents, _14_mutableEvents, _13_functionalQueryId, _15_mutableQueryId);
      _7_i = BigInteger.Zero;
      while ((_7_i) < (customers)) {
        ...
        BigInteger _out7;
        BigInteger _out8;
        ThunderDbMutableParity.__default.NextRand(_2_rng, out _out7, out _out8);
        _16_nextRng1 = _out7;
        _17_widthSeed = _out8;
        _2_rng = _16_nextRng1;
        ...
        BigInteger _out9;
        BigInteger _out10;
        ThunderDbMutableParity.__default.NextRand(_2_rng, out _out9, out _out10);
        _18_nextRng2 = _out9;
        _19_minSeed = _out10;
        _2_rng = _18_nextRng2;
        ...
        Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _27_mutableAddEvents;
        BigInteger _28_mutableAddQueryId;
        Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _out14;
        BigInteger _out15;
        (this.engine).ProcessItem(_23_item, out _out14, out _out15);
        _27_mutableAddEvents = _out14;
        _28_mutableAddQueryId = _out15;
        ...
        (this).CheckState(name, _6_opIndex, _23_item, _0_state, _25_functionalAddEvents, _27_mutableAddEvents, _26_functionalAddQueryId, _28_mutableAddQueryId);
        _7_i = (_7_i) + (BigInteger.One);
      }
      BigInteger _29_tick;
      ...
      while ((_29_tick) < (ticks)) {
        ...
        while ((_30_update) < (updatesPerTick)) {
          if ((new BigInteger(((_0_state).dtor_docIds).Count)).Sign == 1) {
            ...
            BigInteger _out16;
            BigInteger _out17;
            ThunderDbMutableParity.__default.NextRand(_2_rng, out _out16, out _out17);
            _31_nextRng3 = _out16;
            _32_pickSeed = _out17;
            _2_rng = _31_nextRng3;
            ...
            BigInteger _out18;
            BigInteger _out19;
            ThunderDbMutableParity.__default.NextRand(_2_rng, out _out18, out _out19);
            _33_nextRng4 = _out18;
            ...
            }
            {
              BigInteger _37_docState = _source0.dtor_state;
              {
                ...
                Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _42_mutableUpdateEvents;
                BigInteger _43_mutableUpdateQueryId;
                Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _out23;
                BigInteger _out24;
                (this.engine).ProcessItem(_38_item, out _out23, out _out24);
                _42_mutableUpdateEvents = _out23;
                _43_mutableUpdateQueryId = _out24;
                _0_state = _39_stateAfterUpdate;
                _1_summary = ThunderDbStack.__default.UpdateSummary(_1_summary, _40_functionalUpdateEvents);
                _6_opIndex = (_6_opIndex) + (BigInteger.One);
                (this).CheckState(name, _6_opIndex, _38_item, _0_state, _40_functionalUpdateEvents, _42_mutableUpdateEvents, _41_functionalUpdateQueryId, _43_mutableUpdateQueryId);
              }
            }
          after_match0: ;
          }
        ...
        while ((_44_insert) < (insertsPerTick)) {
          ...
          BigInteger _out25;
          BigInteger _out26;
          ThunderDbMutableParity.__default.NextRand(_2_rng, out _out25, out _out26);
          _45_nextRng5 = _out25;
          ...
          Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _51_mutableInsertEvents;
          BigInteger _52_mutableInsertQueryId;
          Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _out30;
          BigInteger _out31;
          (this.engine).ProcessItem(_47_item, out _out30, out _out31);
          _51_mutableInsertEvents = _out30;
          _52_mutableInsertQueryId = _out31;
          ...
          _6_opIndex = (_6_opIndex) + (BigInteger.One);
          (this).CheckState(name, _6_opIndex, _47_item, _0_state, _49_functionalInsertEvents, _51_mutableInsertEvents, _50_functionalInsertQueryId, _52_mutableInsertQueryId);
        ...
        while ((_53_delete) < (deletesPerTick)) {
          if ((new BigInteger(((_0_state).dtor_docIds).Count)).Sign == 1) {
            ...
            BigInteger _out32;
            BigInteger _out33;
            ThunderDbMutableParity.__default.NextRand(_2_rng, out _out32, out _out33);
            _54_nextRng6 = _out32;
            _55_pickSeed = _out33;
            _2_rng = _54_nextRng6;
            ...
            }
            {
              BigInteger _58_docState = _source1.dtor_state;
              {
                ...
                Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _63_mutableDeleteEvents;
                BigInteger _64_mutableDeleteQueryId;
                Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _out37;
                BigInteger _out38;
                (this.engine).ProcessItem(_59_item, out _out37, out _out38);
                _63_mutableDeleteEvents = _out37;
                _64_mutableDeleteQueryId = _out38;
                _0_state = _60_stateAfterDelete;
                _1_summary = ThunderDbStack.__default.UpdateSummary(_1_summary, _61_functionalDeleteEvents);
                _6_opIndex = (_6_opIndex) + (BigInteger.One);
                (this).CheckState(name, _6_opIndex, _59_item, _0_state, _61_functionalDeleteEvents, _63_mutableDeleteEvents, _62_functionalDeleteQueryId, _64_mutableDeleteQueryId);
              }
            }
          after_match1: ;
          }
...
} // end of namespace ThunderDbMutableParity
namespace _module {

} // end of namespace _module
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(() => ThunderDbMutableParity.__default._Main(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.UnicodeFromMainArguments(args)));
  }
}
