// Dafny program CleanLimitSmoke.dfy compiled into C#
...
// Command-line arguments: run specs/clean-dafny/CleanLimitSmoke.dfy --no-verify --allow-warnings
// CleanLimitSmoke.dfy
...
module CleanLimitSmoke {
    ...
    decreases *
  {
    ...
    var ignoredEvents, ignoredQueryId := engine.ProcessItemDeferred(SeedDocsItem([SeedDoc(1, DocState(10)), SeedDoc(2, DocState(20)), SeedDoc(3, DocState(30))]));
    var addEvents, queryId := engine.ProcessItemDeferred(QueryAddItem(QuerySpec(0, 100, 2)));
    expect |addEvents| == 0, ""expectation violation"";
    expect queryId == 1, ""expectation violation"";
    var addRetrievals := engine.DrainPendingRetrievalsGrouped();
    expect |addRetrievals| == 1, ""expectation violation"";
    match addRetrievals[0]
    case {:split false} MatchEvent(payload) =>
      {
        expect false, ""expectation violation"";
      }
    case {:split false} RetrievalEvent(docs) =>
      {
        expect |docs| == 2, ""expectation violation"";
        expect docs[0].docId == 1, ""expectation violation"";
        expect docs[0].queries == [1], ""expectation violation"";
        expect docs[1].docId == 2, ""expectation violation"";
        expect docs[1].queries == [1], ""expectation violation"";
      }
      var updateEvents, ignoredQueryId2 := engine.ProcessItemDeferred(DocChangeItem(1, HasState(DocState(10)), HasState(DocState(40))));
      expect |updateEvents| == 1, ""expectation violation"";
      match updateEvents[0]
      case {:split false} MatchEvent(payload) =>
        {
          expect payload.matchesOld == [1], ""expectation violation"";
          expect payload.matchesNew == [], ""expectation violation"";
        }
      case {:split false} RetrievalEvent(docs) =>
        {
          expect false, ""expectation violation"";
        ...
        case {:split false} RetrievalEvent(docs) =>
          {
            expect |docs| == 1, ""expectation violation"";
            expect docs[0].docId == 3, ""expectation violation"";
            expect docs[0].queries == [1], ""expectation violation"";
          }
          var insertEvents, ignoredQueryId3 := engine.ProcessItemDeferred(DocChangeItem(0, NoState, HasState(DocState(5))));
          expect |insertEvents| == 1, ""expectation violation"";
          match insertEvents[0]
          case {:split false} MatchEvent(payload) =>
            {
              expect payload.matchesOld == [], ""expectation violation"";
              expect payload.matchesNew == [1], ""expectation violation"";
              expect |payload.evictions| == 1, ""expectation violation"";
              expect payload.evictions[0] == Eviction(1, 3), ""expectation violation"";
            }
          case {:split false} RetrievalEvent(docs) =>
            {
              expect false, ""expectation violation"";
            ...
            expect visible == [0, 2], ""expectation violation"";
            expect engine.pendingState == EmptyPendingState(), ""expectation violation"";
...
namespace CleanLimitSmoke {
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      _nw0.__ctor();
      _0_engine = _nw0;
      Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _1_ignoredEvents;
      BigInteger _2_ignoredQueryId;
      Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _out0;
      BigInteger _out1;
      (_0_engine).ProcessItemDeferred(ThunderDbStack.StreamItem.create_SeedDocsItem(Dafny.Sequence<ThunderDbStack._ISeedDoc>.FromElements(ThunderDbStack.SeedDoc.create(BigInteger.One, new BigInteger(10)), ThunderDbStack.SeedDoc.create(new BigInteger(2), new BigInteger(20)), ThunderDbStack.SeedDoc.create(new BigInteger(3), new BigInteger(30)))), out _out0, out _out1);
      _1_ignoredEvents = _out0;
      _2_ignoredQueryId = _out1;
      Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _3_addEvents;
      BigInteger _4_queryId;
      Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _out2;
      BigInteger _out3;
      (_0_engine).ProcessItemDeferred(ThunderDbStack.StreamItem.create_QueryAddItem(ThunderDbStack.QuerySpec.create(BigInteger.Zero, new BigInteger(100), new BigInteger(2))), out _out2, out _out3);
      _3_addEvents = _out2;
      _4_queryId = _out3;
      if (!((new BigInteger((_3_addEvents).Count)).Sign == 0)) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(21,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((_4_queryId) == (BigInteger.One))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(22,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _5_addRetrievals;
      Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _out4;
      _out4 = (_0_engine).DrainPendingRetrievalsGrouped();
      _5_addRetrievals = _out4;
      if (!((new BigInteger((_5_addRetrievals).Count)) == (BigInteger.One))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(25,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      ThunderDbStack._IDownstreamEvent _source0 = (_5_addRetrievals).Select(BigInteger.Zero);
      {
        if (_source0.is_MatchEvent) {
          ThunderDbStack._IMatchPayload _6_payload = _source0.dtor_payload;
          {
            if (!(false)) {
              throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(28,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
          }
          goto after_match0;
        }
      }
      {
        Dafny.ISequence<ThunderDbStack._IRetrievalDoc> _7_docs = _source0.dtor_docs;
        {
          if (!((new BigInteger((_7_docs).Count)) == (new BigInteger(2)))) {
            throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(31,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
          if (!((((_7_docs).Select(BigInteger.Zero)).dtor_docId) == (BigInteger.One))) {
            throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(32,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
          if (!((((_7_docs).Select(BigInteger.Zero)).dtor_queries).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
            throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(33,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
          if (!((((_7_docs).Select(BigInteger.One)).dtor_docId) == (new BigInteger(2)))) {
            throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(34,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
          if (!((((_7_docs).Select(BigInteger.One)).dtor_queries).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
            throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(35,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        }
        Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _8_updateEvents;
        BigInteger _9_ignoredQueryId2;
        Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _out5;
        BigInteger _out6;
        (_0_engine).ProcessItemDeferred(ThunderDbStack.StreamItem.create_DocChangeItem(BigInteger.One, ThunderDbStack.MaybeDocState.create_HasState(new BigInteger(10)), ThunderDbStack.MaybeDocState.create_HasState(new BigInteger(40))), out _out5, out _out6);
        _8_updateEvents = _out5;
        _9_ignoredQueryId2 = _out6;
        if (!((new BigInteger((_8_updateEvents).Count)) == (BigInteger.One))) {
          throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(39,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        ThunderDbStack._IDownstreamEvent _source1 = (_8_updateEvents).Select(BigInteger.Zero);
        {
          if (_source1.is_MatchEvent) {
            ThunderDbStack._IMatchPayload _10_payload = _source1.dtor_payload;
            {
              if (!(((_10_payload).dtor_matchesOld).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
                throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(42,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
              if (!(((_10_payload).dtor_matchesNew).Equals(Dafny.Sequence<BigInteger>.FromElements()))) {
                throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(43,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
            }
            goto after_match1;
          }
        }
        {
          Dafny.ISequence<ThunderDbStack._IRetrievalDoc> _11_docs = _source1.dtor_docs;
          {
            if (!(false)) {
              throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(46,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
          }
          Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _12_updateRetrievals;
          Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _out7;
          _out7 = (_0_engine).DrainPendingRetrievalsGrouped();
          _12_updateRetrievals = _out7;
          ThunderDbStack._IDownstreamEvent _source2 = (_12_updateRetrievals).Select(BigInteger.Zero);
          {
            if (_source2.is_MatchEvent) {
              ThunderDbStack._IMatchPayload _13_payload = _source2.dtor_payload;
              {
                if (!(false)) {
                  throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(52,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
              }
              goto after_match2;
            }
          }
          {
            Dafny.ISequence<ThunderDbStack._IRetrievalDoc> _14_docs = _source2.dtor_docs;
            {
              if (!((new BigInteger((_14_docs).Count)) == (BigInteger.One))) {
                throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(55,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
              if (!((((_14_docs).Select(BigInteger.Zero)).dtor_docId) == (new BigInteger(3)))) {
                throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(56,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
              if (!((((_14_docs).Select(BigInteger.Zero)).dtor_queries).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
                throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(57,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
            }
            Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _15_insertEvents;
            BigInteger _16_ignoredQueryId3;
            Dafny.ISequence<ThunderDbStack._IDownstreamEvent> _out8;
            BigInteger _out9;
            (_0_engine).ProcessItemDeferred(ThunderDbStack.StreamItem.create_DocChangeItem(BigInteger.Zero, ThunderDbStack.MaybeDocState.create_NoState(), ThunderDbStack.MaybeDocState.create_HasState(new BigInteger(5))), out _out8, out _out9);
            _15_insertEvents = _out8;
            _16_ignoredQueryId3 = _out9;
            if (!((new BigInteger((_15_insertEvents).Count)) == (BigInteger.One))) {
              throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(61,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
            ThunderDbStack._IDownstreamEvent _source3 = (_15_insertEvents).Select(BigInteger.Zero);
            {
              if (_source3.is_MatchEvent) {
                ThunderDbStack._IMatchPayload _17_payload = _source3.dtor_payload;
                {
                  if (!(((_17_payload).dtor_matchesOld).Equals(Dafny.Sequence<BigInteger>.FromElements()))) {
                    throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(64,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
                  if (!(((_17_payload).dtor_matchesNew).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
                    throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(65,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
                  if (!((new BigInteger(((_17_payload).dtor_evictions).Count)) == (BigInteger.One))) {
                    throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(66,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
                  if (!(object.Equals(((_17_payload).dtor_evictions).Select(BigInteger.Zero), ThunderDbStack.Eviction.create(BigInteger.One, new BigInteger(3))))) {
                    throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(67,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
                }
                goto after_match3;
              }
            }
            {
              Dafny.ISequence<ThunderDbStack._IRetrievalDoc> _18_docs = _source3.dtor_docs;
              {
                if (!(false)) {
                  throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(70,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
              }
              Dafny.ISequence<BigInteger> _19_visible;
              Dafny.ISequence<BigInteger> _out10;
              _out10 = (_0_engine).QueryVisible(BigInteger.One);
              _19_visible = _out10;
              if (!((_19_visible).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.Zero, new BigInteger(2))))) {
                throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(74,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
              if (!(object.Equals(_0_engine.pendingState, CleanPendingRuntime.__default.EmptyPendingState()))) {
                throw new Dafny.HaltException("specs/clean-dafny/CleanLimitSmoke.dfy(75,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
              Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("clean-limit-smoke passed\n")).ToVerbatimString(false));
            }
          after_match3: ;
          }
        after_match2: ;
...
} // end of namespace CleanLimitSmoke
namespace _module {

} // end of namespace _module
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(() => CleanLimitSmoke.__default._Main(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.UnicodeFromMainArguments(args)));
  }
}
