// Dafny program CleanPendingSmoke.dfy compiled into C#
...
// Command-line arguments: run specs/clean-dafny/CleanPendingSmoke.dfy --no-verify --allow-warnings
// CleanPendingSmoke.dfy
...
module CleanPendingSmoke {
    ...
    decreases *
  {
    ...
    expect registry.state.docOrder == [10, 11], ""expectation violation"";
    expect pendingQueries10 == [1, 2], ""expectation violation"";
    expect pendingDocs1 == [10, 11], ""expectation violation"";
    var cancelled := registry.Cancel(10, 2);
    var pendingQueries10AfterCancel := registry.PendingQueries(10);
    expect cancelled, ""expectation violation"";
    expect pendingQueries10AfterCancel == [1], ""expectation violation"";
    registry.ResolveDoc(11);
    var pendingDocs1AfterResolve := registry.PendingDocs(1);
    expect pendingDocs1AfterResolve == [10], ""expectation violation"";
    ...
    expect docs[0].docId == 10, ""expectation violation"";
    expect docs[0].queries == [1], ""expectation violation"";
    expect docs[1].docId == 12, ""expectation violation"";
    expect docs[1].queries == [3], ""expectation violation"";
    expect registry.state == EmptyPendingState(), ""expectation violation"";
...
module CleanPendingLemmas {
  lemma /*{:_inductionTrigger RemoveQueryId(ids, id)}*/ /*{:_induction ids, id}*/ RemoveQueryIdDoesNotGrow(ids: seq<QueryId>, id: QueryId)
...
namespace CleanPendingSmoke {

  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      CleanPendingRuntime.PendingRegistry _0_registry;
      CleanPendingRuntime.PendingRegistry _nw0 = new CleanPendingRuntime.PendingRegistry();
      _nw0.__ctor();
      _0_registry = _nw0;
      (_0_registry).Register(new BigInteger(10), BigInteger.One);
      (_0_registry).Register(new BigInteger(10), new BigInteger(2));
      (_0_registry).Register(new BigInteger(11), BigInteger.One);
      Dafny.ISequence<BigInteger> _1_pendingQueries10;
      Dafny.ISequence<BigInteger> _out0;
      _out0 = (_0_registry).PendingQueries(new BigInteger(10));
      _1_pendingQueries10 = _out0;
      Dafny.ISequence<BigInteger> _2_pendingDocs1;
      Dafny.ISequence<BigInteger> _out1;
      _out1 = (_0_registry).PendingDocs(BigInteger.One);
      _2_pendingDocs1 = _out1;
      if (!(((_0_registry.state).dtor_docOrder).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(10), new BigInteger(11))))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(19,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((_1_pendingQueries10).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One, new BigInteger(2))))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(20,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((_2_pendingDocs1).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(10), new BigInteger(11))))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(21,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      bool _3_cancelled;
      bool _out2;
      _out2 = (_0_registry).Cancel(new BigInteger(10), new BigInteger(2));
      _3_cancelled = _out2;
      Dafny.ISequence<BigInteger> _4_pendingQueries10AfterCancel;
      Dafny.ISequence<BigInteger> _out3;
      _out3 = (_0_registry).PendingQueries(new BigInteger(10));
      _4_pendingQueries10AfterCancel = _out3;
      if (!(_3_cancelled)) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(25,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((_4_pendingQueries10AfterCancel).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(26,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      (_0_registry).ResolveDoc(new BigInteger(11));
      Dafny.ISequence<BigInteger> _5_pendingDocs1AfterResolve;
      Dafny.ISequence<BigInteger> _out4;
      _out4 = (_0_registry).PendingDocs(BigInteger.One);
      _5_pendingDocs1AfterResolve = _out4;
      if (!((_5_pendingDocs1AfterResolve).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(10))))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(30,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      (_0_registry).Register(new BigInteger(12), new BigInteger(3));
      Dafny.IMap<BigInteger,BigInteger> _6_store;
      _6_store = Dafny.Map<BigInteger, BigInteger>.FromElements(new Dafny.Pair<BigInteger, BigInteger>(new BigInteger(10), new BigInteger(5)), new Dafny.Pair<BigInteger, BigInteger>(new BigInteger(12), new BigInteger(9)));
      Dafny.ISequence<ThunderDbStack._IRetrievalDoc> _7_docs;
      Dafny.ISequence<ThunderDbStack._IRetrievalDoc> _out5;
      _out5 = (_0_registry).DrainGrouped(_6_store);
      _7_docs = _out5;
      if (!((new BigInteger((_7_docs).Count)) == (new BigInteger(2)))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(37,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((((_7_docs).Select(BigInteger.Zero)).dtor_docId) == (new BigInteger(10)))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(38,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((((_7_docs).Select(BigInteger.Zero)).dtor_queries).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(39,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((((_7_docs).Select(BigInteger.One)).dtor_docId) == (new BigInteger(12)))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(40,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((((_7_docs).Select(BigInteger.One)).dtor_queries).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(3))))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(41,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals(_0_registry.state, CleanPendingRuntime.__default.EmptyPendingState()))) {
        throw new Dafny.HaltException("specs/clean-dafny/CleanPendingSmoke.dfy(42,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("clean-pending-smoke passed\n")).ToVerbatimString(false));
    }
  }
} // end of namespace CleanPendingSmoke
namespace CleanPendingLemmas {

} // end of namespace CleanPendingLemmas
namespace _module {

} // end of namespace _module
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(() => CleanPendingSmoke.__default._Main(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.UnicodeFromMainArguments(args)));
  }
}
