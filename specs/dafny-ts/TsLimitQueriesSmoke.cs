// Dafny program TsLimitQueriesSmoke.dfy compiled into C#
...
// Command-line arguments: run specs/dafny-ts/TsLimitQueriesSmoke.dfy --no-verify --allow-warnings
// TsLimitQueriesSmoke.dfy
...
module TsLimitQueriesSmoke {
  method Main(_noArgsParameter: seq<seq<char>>)
  {
    ...
    expect LimitQueriesConsistent(state), ""expectation violation"";
    state := AddDocument(state, 10, 1).state;
    state := AddDocument(state, 20, 2).state;
    state := AddDocument(state, 30, 3).state;
    expect state.docs.entries == [Entry(10, 1), Entry(20, 2), Entry(30, 3)], ""expectation violation"";
    var added := TsLimitQueriesRuntime.AddQuery(state, 0, 2, 100);
    state := added.state;
    expect added.queryId == 1, ""expectation violation"";
    expect state.infos[1] == QueryInfo(1, 0, 2, 100, 2), ""expectation violation"";
    expect GetDocsForQuery(state, 1) == [1, 2], ""expectation violation"";
    var removed := RemoveDocument(state, 10, 1);
    state := removed.state;
    expect removed.removed == [1], ""expectation violation"";
    expect state.infos[1].currentMatches == 1, ""expectation violation"";
    var gap := FillGap(state, 1);
    state := gap.state;
    expect gap.doc == SomeDoc(3), ""expectation violation"";
    expect state.infos[1].currentMatches == 2, ""expectation violation"";
    expect state.pendingByQuery[1] == [3], ""expectation violation"";
    expect state.pendingByDoc[3] == [1], ""expectation violation"";
    var cancelled := CancelPendingForQuery(state, 3, 1);
    state := cancelled.state;
    expect cancelled.changed, ""expectation violation"";
    expect state.infos[1].currentMatches == 1, ""expectation violation"";
    expect !(1 in state.pendingByQuery), ""expectation violation"";
    expect !(3 in state.pendingByDoc), ""expectation violation"";
    gap := FillGap(state, 1);
    state := gap.state;
    expect gap.doc == SomeDoc(3), ""expectation violation"";
    ...
    expect addedDoc.matched == [1], ""expectation violation"";
    expect addedDoc.blocked == [1], ""expectation violation"";
    expect state.infos[1].currentMatches == 2, ""expectation violation"";
    expect PickOverflowDoc(state, 1) == SomeDoc(3), ""expectation violation"";
    var removedQuery := TsLimitQueriesRuntime.RemoveQuery(state, 1);
    state := removedQuery.state;
    expect removedQuery.changed, ""expectation violation"";
    expect !(1 in state.infos), ""expectation violation"";
    expect !(1 in state.baseScores), ""expectation violation"";
...
namespace TsLimitQueriesSmoke {

  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      TsLimitQueriesRuntime._ILimitQueriesState _0_state;
      _0_state = TsLimitQueriesRuntime.__default.EmptyLimitQueriesState();
      if (!(TsLimitQueriesRuntime.__default.LimitQueriesConsistent(_0_state))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(9,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = (TsLimitQueriesRuntime.__default.AddDocument(_0_state, new BigInteger(10), BigInteger.One)).dtor_state;
      _0_state = (TsLimitQueriesRuntime.__default.AddDocument(_0_state, new BigInteger(20), new BigInteger(2))).dtor_state;
      _0_state = (TsLimitQueriesRuntime.__default.AddDocument(_0_state, new BigInteger(30), new BigInteger(3))).dtor_state;
      if (!((((_0_state).dtor_docs)).Equals(Dafny.Sequence<DocsIndexModel._IEntry>.FromElements(DocsIndexModel.Entry.create(new BigInteger(10), BigInteger.One), DocsIndexModel.Entry.create(new BigInteger(20), new BigInteger(2)), DocsIndexModel.Entry.create(new BigInteger(30), new BigInteger(3)))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(14,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      TsLimitQueriesRuntime._IQueryAddResult _1_added;
      _1_added = TsLimitQueriesRuntime.__default.AddQuery(_0_state, BigInteger.Zero, new BigInteger(2), new BigInteger(100));
      _0_state = (_1_added).dtor_state;
      if (!(((_1_added).dtor_queryId) == (BigInteger.One))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(18,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals(Dafny.Map<BigInteger, TsLimitQueriesRuntime._IQueryInfo>.Select((_0_state).dtor_infos,BigInteger.One), TsLimitQueriesRuntime.QueryInfo.create(BigInteger.One, BigInteger.Zero, new BigInteger(2), new BigInteger(100), new BigInteger(2))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(19,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsLimitQueriesRuntime.__default.GetDocsForQuery(_0_state, BigInteger.One)).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One, new BigInteger(2))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(20,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      TsLimitQueriesRuntime._IRemoveDocumentResult _2_removed;
      _2_removed = TsLimitQueriesRuntime.__default.RemoveDocument(_0_state, new BigInteger(10), BigInteger.One);
      _0_state = (_2_removed).dtor_state;
      if (!(((_2_removed).dtor_removed).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(24,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(((Dafny.Map<BigInteger, TsLimitQueriesRuntime._IQueryInfo>.Select((_0_state).dtor_infos,BigInteger.One)).dtor_currentMatches) == (BigInteger.One))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(25,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      TsLimitQueriesRuntime._IGapFillResult _3_gap;
      _3_gap = TsLimitQueriesRuntime.__default.FillGap(_0_state, BigInteger.One);
      _0_state = (_3_gap).dtor_state;
      if (!(object.Equals((_3_gap).dtor_doc, DocsIndexModel.MaybeDocId.create_SomeDoc(new BigInteger(3))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(29,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(((Dafny.Map<BigInteger, TsLimitQueriesRuntime._IQueryInfo>.Select((_0_state).dtor_infos,BigInteger.One)).dtor_currentMatches) == (new BigInteger(2)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(30,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((Dafny.Map<BigInteger, Dafny.ISequence<BigInteger>>.Select((_0_state).dtor_pendingByQuery,BigInteger.One)).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(3))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(31,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((Dafny.Map<BigInteger, Dafny.ISequence<BigInteger>>.Select((_0_state).dtor_pendingByDoc,new BigInteger(3))).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(32,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      TsLimitQueriesRuntime._IStateChange _4_cancelled;
      _4_cancelled = TsLimitQueriesRuntime.__default.CancelPendingForQuery(_0_state, new BigInteger(3), BigInteger.One);
      _0_state = (_4_cancelled).dtor_state;
      if (!((_4_cancelled).dtor_changed)) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(36,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(((Dafny.Map<BigInteger, TsLimitQueriesRuntime._IQueryInfo>.Select((_0_state).dtor_infos,BigInteger.One)).dtor_currentMatches) == (BigInteger.One))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(37,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(!(((_0_state).dtor_pendingByQuery).Contains(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(38,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(!(((_0_state).dtor_pendingByDoc).Contains(new BigInteger(3))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(39,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _3_gap = TsLimitQueriesRuntime.__default.FillGap(_0_state, BigInteger.One);
      _0_state = (_3_gap).dtor_state;
      if (!(object.Equals((_3_gap).dtor_doc, DocsIndexModel.MaybeDocId.create_SomeDoc(new BigInteger(3))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(43,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = TsLimitQueriesRuntime.__default.ResolvePendingForDoc(_0_state, new BigInteger(3));
      if (!(!(((_0_state).dtor_pendingByQuery).Contains(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(45,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(!(((_0_state).dtor_pendingByDoc).Contains(new BigInteger(3))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(46,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      TsLimitQueriesRuntime._IAddDocumentResult _5_addedDoc;
      _5_addedDoc = TsLimitQueriesRuntime.__default.AddDocument(_0_state, new BigInteger(5), BigInteger.Zero);
      _0_state = (_5_addedDoc).dtor_state;
      if (!(((_5_addedDoc).dtor_matched).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(50,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(((_5_addedDoc).dtor_blocked).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(51,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(((Dafny.Map<BigInteger, TsLimitQueriesRuntime._IQueryInfo>.Select((_0_state).dtor_infos,BigInteger.One)).dtor_currentMatches) == (new BigInteger(2)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(52,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals(TsLimitQueriesRuntime.__default.PickOverflowDoc(_0_state, BigInteger.One), DocsIndexModel.MaybeDocId.create_SomeDoc(new BigInteger(3))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(54,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      TsLimitQueriesRuntime._IStateChange _6_removedQuery;
      _6_removedQuery = TsLimitQueriesRuntime.__default.RemoveQuery(_0_state, BigInteger.One);
      _0_state = (_6_removedQuery).dtor_state;
      if (!((_6_removedQuery).dtor_changed)) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(58,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(!(((_0_state).dtor_infos).Contains(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(59,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(!(((_0_state).dtor_baseScores).Contains(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsLimitQueriesSmoke.dfy(60,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("ts-limit-queries-smoke passed\n")).ToVerbatimString(false));
    }
  }
} // end of namespace TsLimitQueriesSmoke
...
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(() => TsLimitQueriesSmoke.__default._Main(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.UnicodeFromMainArguments(args)));
  }
}
