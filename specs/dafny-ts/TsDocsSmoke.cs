// Dafny program TsDocsSmoke.dfy compiled into C#
...
// Command-line arguments: run specs/dafny-ts/TsDocsSmoke.dfy --no-verify --allow-warnings
// TsDocsSmoke.dfy
...
module TsDocsSmoke {
  method Main(_noArgsParameter: seq<seq<char>>)
  {
    ...
    expect DocsConsistent(state), ""expectation violation"";
    expect RankDoc(state, 10, NoDoc) == 0, ""expectation violation"";
    expect CountAtMostDoc(state, 10) == 0, ""expectation violation"";
    expect GetAtRankDoc(state, 0) == Missing, ""expectation violation"";
    ...
    expect DocsConsistent(state), ""expectation violation"";
    expect state.entries == [Entry(10, 3), Entry(10, 5), Entry(20, 2), Entry(30, 1)], ""expectation violation"";
    expect RankDoc(state, 10, NoDoc) == 0, ""expectation violation"";
    expect RankDoc(state, 10, SomeDoc(4)) == 1, ""expectation violation"";
    expect RankDoc(state, 10, SomeDoc(5)) == 1, ""expectation violation"";
    expect RankDoc(state, 20, NoDoc) == 2, ""expectation violation"";
    expect CountAtMostDoc(state, 9) == 0, ""expectation violation"";
    expect CountAtMostDoc(state, 10) == 2, ""expectation violation"";
    expect CountAtMostDoc(state, 25) == 3, ""expectation violation"";
    expect CountAtMostDoc(state, 30) == 4, ""expectation violation"";
    expect GetAtRankDoc(state, 0) == Found(10, 3, 0), ""expectation violation"";
    expect GetAtRankDoc(state, 1) == Found(10, 5, 1), ""expectation violation"";
    expect GetAtRankDoc(state, 2) == Found(20, 2, 0), ""expectation violation"";
    expect GetAtRankDoc(state, 4) == Missing, ""expectation violation"";
    expect CollectRangeDocs(state, 10, 20, 10) == [3, 5, 2], ""expectation violation"";
    expect CollectRangeDocs(state, 11, 30, 2) == [2, 1], ""expectation violation"";
    expect CollectRangeDocs(state, 31, 40, 5) == [], ""expectation violation"";
    state := RemoveDoc(state, 10, 5);
    expect state.entries == [Entry(10, 3), Entry(20, 2), Entry(30, 1)], ""expectation violation"";
    state := RemoveDoc(state, 20, 999);
    expect state.entries == [Entry(10, 3), Entry(20, 2), Entry(30, 1)], ""expectation violation"";
    state := RemoveDoc(state, 10, 3);
    state := RemoveDoc(state, 20, 2);
    state := RemoveDoc(state, 30, 1);
    expect state.entries == [], ""expectation violation"";
    expect GetAtRankDoc(state, 0) == Missing, ""expectation violation"";
...
module TsDocsLemmas {
  lemma /*{:_inductionTrigger InsertUnique(state.entries, score, id)}*/ /*{:_inductionTrigger AddDoc(state, score, id)}*/ /*{:_induction score, id}*/ AddDocChangesOnlyEntries(state: DocsState, score: Score, id: DocId)
  ...
  lemma /*{:_inductionTrigger RemoveOne(state.entries, score, id)}*/ /*{:_inductionTrigger RemoveDoc(state, score, id)}*/ /*{:_induction score, id}*/ RemoveDocChangesOnlyEntries(state: DocsState, score: Score, id: DocId)
    requires DocsConsistent(state)
...
namespace TsDocsSmoke {

  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Dafny.ISequence<DocsIndexModel._IEntry> _0_state;
      _0_state = TsDocsRuntime.__default.EmptyDocsState();
      if (!(TsDocsRuntime.__default.DocsConsistent(_0_state))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(9,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.RankDoc(_0_state, new BigInteger(10), DocsIndexModel.MaybeDocId.create_NoDoc())).Sign == 0)) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(10,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.CountAtMostDoc(_0_state, new BigInteger(10))).Sign == 0)) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(11,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals(TsDocsRuntime.__default.GetAtRankDoc(_0_state, BigInteger.Zero), DocsIndexModel.AtRank.create_Missing()))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(12,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = TsDocsRuntime.__default.AddDoc(_0_state, new BigInteger(20), new BigInteger(2));
      _0_state = TsDocsRuntime.__default.AddDoc(_0_state, new BigInteger(10), new BigInteger(5));
      _0_state = TsDocsRuntime.__default.AddDoc(_0_state, new BigInteger(10), new BigInteger(3));
      _0_state = TsDocsRuntime.__default.AddDoc(_0_state, new BigInteger(10), new BigInteger(3));
      _0_state = TsDocsRuntime.__default.AddDoc(_0_state, new BigInteger(30), BigInteger.One);
      if (!(TsDocsRuntime.__default.DocsConsistent(_0_state))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(20,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(((_0_state)).Equals(Dafny.Sequence<DocsIndexModel._IEntry>.FromElements(DocsIndexModel.Entry.create(new BigInteger(10), new BigInteger(3)), DocsIndexModel.Entry.create(new BigInteger(10), new BigInteger(5)), DocsIndexModel.Entry.create(new BigInteger(20), new BigInteger(2)), DocsIndexModel.Entry.create(new BigInteger(30), BigInteger.One))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(21,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.RankDoc(_0_state, new BigInteger(10), DocsIndexModel.MaybeDocId.create_NoDoc())).Sign == 0)) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(22,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.RankDoc(_0_state, new BigInteger(10), DocsIndexModel.MaybeDocId.create_SomeDoc(new BigInteger(4)))) == (BigInteger.One))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(23,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.RankDoc(_0_state, new BigInteger(10), DocsIndexModel.MaybeDocId.create_SomeDoc(new BigInteger(5)))) == (BigInteger.One))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(24,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.RankDoc(_0_state, new BigInteger(20), DocsIndexModel.MaybeDocId.create_NoDoc())) == (new BigInteger(2)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(25,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.CountAtMostDoc(_0_state, new BigInteger(9))).Sign == 0)) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(26,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.CountAtMostDoc(_0_state, new BigInteger(10))) == (new BigInteger(2)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(27,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.CountAtMostDoc(_0_state, new BigInteger(25))) == (new BigInteger(3)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(28,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.CountAtMostDoc(_0_state, new BigInteger(30))) == (new BigInteger(4)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(29,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals(TsDocsRuntime.__default.GetAtRankDoc(_0_state, BigInteger.Zero), DocsIndexModel.AtRank.create_Found(new BigInteger(10), new BigInteger(3), BigInteger.Zero)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(31,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals(TsDocsRuntime.__default.GetAtRankDoc(_0_state, BigInteger.One), DocsIndexModel.AtRank.create_Found(new BigInteger(10), new BigInteger(5), BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(32,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals(TsDocsRuntime.__default.GetAtRankDoc(_0_state, new BigInteger(2)), DocsIndexModel.AtRank.create_Found(new BigInteger(20), new BigInteger(2), BigInteger.Zero)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(33,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals(TsDocsRuntime.__default.GetAtRankDoc(_0_state, new BigInteger(4)), DocsIndexModel.AtRank.create_Missing()))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(34,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.CollectRangeDocs(_0_state, new BigInteger(10), new BigInteger(20), new BigInteger(10))).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(3), new BigInteger(5), new BigInteger(2))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(36,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.CollectRangeDocs(_0_state, new BigInteger(11), new BigInteger(30), new BigInteger(2))).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(2), BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(37,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((TsDocsRuntime.__default.CollectRangeDocs(_0_state, new BigInteger(31), new BigInteger(40), new BigInteger(5))).Equals(Dafny.Sequence<BigInteger>.FromElements()))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(38,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = TsDocsRuntime.__default.RemoveDoc(_0_state, new BigInteger(10), new BigInteger(5));
      if (!(((_0_state)).Equals(Dafny.Sequence<DocsIndexModel._IEntry>.FromElements(DocsIndexModel.Entry.create(new BigInteger(10), new BigInteger(3)), DocsIndexModel.Entry.create(new BigInteger(20), new BigInteger(2)), DocsIndexModel.Entry.create(new BigInteger(30), BigInteger.One))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(41,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = TsDocsRuntime.__default.RemoveDoc(_0_state, new BigInteger(20), new BigInteger(999));
      if (!(((_0_state)).Equals(Dafny.Sequence<DocsIndexModel._IEntry>.FromElements(DocsIndexModel.Entry.create(new BigInteger(10), new BigInteger(3)), DocsIndexModel.Entry.create(new BigInteger(20), new BigInteger(2)), DocsIndexModel.Entry.create(new BigInteger(30), BigInteger.One))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(44,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = TsDocsRuntime.__default.RemoveDoc(_0_state, new BigInteger(10), new BigInteger(3));
      _0_state = TsDocsRuntime.__default.RemoveDoc(_0_state, new BigInteger(20), new BigInteger(2));
      _0_state = TsDocsRuntime.__default.RemoveDoc(_0_state, new BigInteger(30), BigInteger.One);
      if (!(((_0_state)).Equals(Dafny.Sequence<DocsIndexModel._IEntry>.FromElements()))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(49,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals(TsDocsRuntime.__default.GetAtRankDoc(_0_state, BigInteger.Zero), DocsIndexModel.AtRank.create_Missing()))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsDocsSmoke.dfy(50,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("ts-docs-smoke passed\n")).ToVerbatimString(false));
    }
  }
} // end of namespace TsDocsSmoke
namespace TsDocsLemmas {

} // end of namespace TsDocsLemmas
namespace _module {

} // end of namespace _module
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(() => TsDocsSmoke.__default._Main(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.UnicodeFromMainArguments(args)));
  }
}
