// Dafny program TsRetrievalSmoke.dfy compiled into C#
...
// Command-line arguments: run specs/dafny-ts/TsRetrievalSmoke.dfy --no-verify --allow-warnings
// TsRetrievalSmoke.dfy
...
module TsRetrievalSmoke {
  method Main(_noArgsParameter: seq<seq<char>>)
  {
    ...
    expect WorkerConsistent(state), ""expectation violation"";
    expect !ShouldExit(state), ""expectation violation"";
    state := Register(state, 10, 1);
    state := Register(state, 10, 2);
    state := Register(state, 11, 1);
    state := Register(state, 10, 1);
    expect state.pendingOrder == [10, 11], ""expectation violation"";
    expect state.pendingBatch[10] == [1, 2], ""expectation violation"";
    expect state.pendingBatch[11] == [1], ""expectation violation"";
    expect HasPendingWork(state), ""expectation violation"";
    var cancelledPending := Cancel(state, 10, 2);
    state := cancelledPending.state;
    expect cancelledPending.changed, ""expectation violation"";
    expect state.pendingBatch[10] == [1], ""expectation violation"";
    state := BeginCycle(state);
    expect state.pendingOrder == [], ""expectation violation"";
    expect state.processingOrder == [10, 11], ""expectation violation"";
    expect !CanRegister(state, 10, 1), ""expectation violation"";
    state := Register(state, 12, 3);
    expect state.pendingOrder == [12], ""expectation violation"";
    expect state.pendingBatch[12] == [3], ""expectation violation"";
    ...
    expect docs[0] == RetrievalDoc(10, DocState(5), [1]), ""expectation violation"";
    expect docs[1] == RetrievalDoc(11, DocState(7), [1]), ""expectation violation"";
    var resolved := ResolveDoc(state, 10);
    state := resolved.state;
    expect resolved.changed, ""expectation violation"";
    expect !(10 in state.processingBatch), ""expectation violation"";
    var cancelledProcessing := Cancel(state, 11, 1);
    state := cancelledProcessing.state;
    expect cancelledProcessing.changed, ""expectation violation"";
    expect state.processingOrder == [], ""expectation violation"";
    state := FinishCycle(state);
    expect state.processingBatch == map[], ""expectation violation"";
    state := Stop(state);
    expect !ShouldExit(state), ""expectation violation"";
    state := BeginCycle(state);
    var docs2 := BuildPayload(state, store);
    expect |docs2| == 1, ""expectation violation"";
    expect docs2[0] == RetrievalDoc(12, DocState(9), [3]), ""expectation violation"";
...
namespace TsRetrievalSmoke {

  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      TsRetrievalRuntime._IRetrievalWorkerState _0_state;
      _0_state = TsRetrievalRuntime.__default.EmptyWorkerState();
      if (!(TsRetrievalRuntime.__default.WorkerConsistent(_0_state))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(11,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(!(TsRetrievalRuntime.__default.ShouldExit(_0_state)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(12,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = TsRetrievalRuntime.__default.Register(_0_state, new BigInteger(10), BigInteger.One);
      _0_state = TsRetrievalRuntime.__default.Register(_0_state, new BigInteger(10), new BigInteger(2));
      _0_state = TsRetrievalRuntime.__default.Register(_0_state, new BigInteger(11), BigInteger.One);
      _0_state = TsRetrievalRuntime.__default.Register(_0_state, new BigInteger(10), BigInteger.One);
      if (!(((_0_state).dtor_pendingOrder).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(10), new BigInteger(11))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(19,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((Dafny.Map<BigInteger, Dafny.ISequence<BigInteger>>.Select((_0_state).dtor_pendingBatch,new BigInteger(10))).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One, new BigInteger(2))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(20,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((Dafny.Map<BigInteger, Dafny.ISequence<BigInteger>>.Select((_0_state).dtor_pendingBatch,new BigInteger(11))).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(21,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(TsRetrievalRuntime.__default.HasPendingWork(_0_state))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(22,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      TsRetrievalRuntime._IStateChange _1_cancelledPending;
      _1_cancelledPending = TsRetrievalRuntime.__default.Cancel(_0_state, new BigInteger(10), new BigInteger(2));
      _0_state = (_1_cancelledPending).dtor_state;
      if (!((_1_cancelledPending).dtor_changed)) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(26,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((Dafny.Map<BigInteger, Dafny.ISequence<BigInteger>>.Select((_0_state).dtor_pendingBatch,new BigInteger(10))).Equals(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(27,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = TsRetrievalRuntime.__default.BeginCycle(_0_state);
      if (!(((_0_state).dtor_pendingOrder).Equals(Dafny.Sequence<BigInteger>.FromElements()))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(30,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(((_0_state).dtor_processingOrder).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(10), new BigInteger(11))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(31,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(!(TsRetrievalRuntime.__default.CanRegister(_0_state, new BigInteger(10), BigInteger.One)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(32,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = TsRetrievalRuntime.__default.Register(_0_state, new BigInteger(12), new BigInteger(3));
      if (!(((_0_state).dtor_pendingOrder).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(12))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(35,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((Dafny.Map<BigInteger, Dafny.ISequence<BigInteger>>.Select((_0_state).dtor_pendingBatch,new BigInteger(12))).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(3))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(36,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      Dafny.IMap<BigInteger,BigInteger> _2_store;
      _2_store = Dafny.Map<BigInteger, BigInteger>.FromElements(new Dafny.Pair<BigInteger, BigInteger>(new BigInteger(10), new BigInteger(5)), new Dafny.Pair<BigInteger, BigInteger>(new BigInteger(11), new BigInteger(7)), new Dafny.Pair<BigInteger, BigInteger>(new BigInteger(12), new BigInteger(9)));
      Dafny.ISequence<ThunderDbStack._IRetrievalDoc> _3_docs;
      _3_docs = TsRetrievalRuntime.__default.BuildPayload(_0_state, _2_store);
      if (!((new BigInteger((_3_docs).Count)) == (new BigInteger(2)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(40,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((_3_docs).Select(BigInteger.Zero), ThunderDbStack.RetrievalDoc.create(new BigInteger(10), new BigInteger(5), Dafny.Sequence<BigInteger>.FromElements(BigInteger.One))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(41,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((_3_docs).Select(BigInteger.One), ThunderDbStack.RetrievalDoc.create(new BigInteger(11), new BigInteger(7), Dafny.Sequence<BigInteger>.FromElements(BigInteger.One))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(42,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      TsRetrievalRuntime._IStateChange _4_resolved;
      _4_resolved = TsRetrievalRuntime.__default.ResolveDoc(_0_state, new BigInteger(10));
      _0_state = (_4_resolved).dtor_state;
      if (!((_4_resolved).dtor_changed)) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(46,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(!(((_0_state).dtor_processingBatch).Contains(new BigInteger(10))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(47,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      TsRetrievalRuntime._IStateChange _5_cancelledProcessing;
      _5_cancelledProcessing = TsRetrievalRuntime.__default.Cancel(_0_state, new BigInteger(11), BigInteger.One);
      _0_state = (_5_cancelledProcessing).dtor_state;
      if (!((_5_cancelledProcessing).dtor_changed)) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(51,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(((_0_state).dtor_processingOrder).Equals(Dafny.Sequence<BigInteger>.FromElements()))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(52,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = TsRetrievalRuntime.__default.FinishCycle(_0_state);
      if (!(((_0_state).dtor_processingBatch).Equals(Dafny.Map<BigInteger, Dafny.ISequence<BigInteger>>.FromElements()))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(55,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = TsRetrievalRuntime.__default.Stop(_0_state);
      if (!(!(TsRetrievalRuntime.__default.ShouldExit(_0_state)))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(58,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = TsRetrievalRuntime.__default.BeginCycle(_0_state);
      Dafny.ISequence<ThunderDbStack._IRetrievalDoc> _6_docs2;
      _6_docs2 = TsRetrievalRuntime.__default.BuildPayload(_0_state, _2_store);
      if (!((new BigInteger((_6_docs2).Count)) == (BigInteger.One))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(62,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((_6_docs2).Select(BigInteger.Zero), ThunderDbStack.RetrievalDoc.create(new BigInteger(12), new BigInteger(9), Dafny.Sequence<BigInteger>.FromElements(new BigInteger(3)))))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(63,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      _0_state = (TsRetrievalRuntime.__default.ResolveDoc(_0_state, new BigInteger(12))).dtor_state;
      _0_state = TsRetrievalRuntime.__default.FinishCycle(_0_state);
      if (!(TsRetrievalRuntime.__default.ShouldExit(_0_state))) {
        throw new Dafny.HaltException("specs/dafny-ts/TsRetrievalSmoke.dfy(67,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("ts-retrieval-smoke passed\n")).ToVerbatimString(false));
    }
  }
} // end of namespace TsRetrievalSmoke
namespace TsRetrievalLemmas {

} // end of namespace TsRetrievalLemmas
namespace _module {

} // end of namespace _module
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(() => TsRetrievalSmoke.__default._Main(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.UnicodeFromMainArguments(args)));
  }
}
